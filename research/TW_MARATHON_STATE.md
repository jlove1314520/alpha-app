...
**最後更新：2026-08-28T06:13+08:00（馬拉松第164輪）**——取鎖乾淨（第163輪FUT正常結束，跳過未做實質工作）。三軌時間戳TW最舊，依輪替選TW；暫停規則仍生效中，繼續跑T86回補第30批：`backfill_t86.py --batch-size 150`。**本批次乾淨在上限收工，未撞TWSE反爬蟲封鎖**，嘗試150天全部新完成（12天無交易/無資料）。**累積已快取達到全範圍3305個工作日的100%以上（腳本回報3319，獨立glob計數3311，兩者都≥3305）——T86三大法人回補在目前`VAL_END=2024-12-31`範圍內已經完成，沒有待處理日期了。**

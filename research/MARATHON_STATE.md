...
**馬拉松全局輪次計數器（2026-08-23 新增，使用者要求）：目前累積 567 輪（含補記的第405輪，見下方缺口說明）。最新一輪：第 567 輪 · 2026-09-19T19:10+08:00 · TW（#73(b)聚合腳本：量測覆蓋率與MA20近零占比，無判定、N不變；詳見REPORT.md第567輪）。前一輪：第 566 輪 · 2026-09-19T18:10+08:00 · 跨市場（fx_twd_gate統一改央行源：量測兩源r=0.9954，[自行裁量]不換預設來源，無判定、N不變；詳見REPORT.md第566輪）。前一輪：第 565 輪 · 2026-09-19T17:03+08:00 · TW（零股失衡度.連續曝險版重測：檢定力前置關卡STATISTICAL_GATE_FAIL不准開跑，未登記試驗；詳見REPORT.md第565輪）

...
**馬拉松全局輪次計數器（2026-08-23 新增，使用者要求）：目前累積 137 輪。最新一輪：第 137 輪 · 2026-08-27T13:04+08:00 · TW · 補大盤MDD/Sortino基準（`benchmark_taiex_stats.py`，暫停單因子試驗規則生效中，屬允許的組合策略回測相關工作，優先序高於T86回補）· VAL：MDD−31.63%/Sortino0.677；TRAIN：MDD−28.72%/Sortino0.561；總報酬吻合原記錄，確認基準無誤；已更新`LEADS.md`備註，原FAIL判定不變。詳見`REPORT.md`第137輪條目、`TW_MARATHON_STATE.md`/`TW_LOG.md`本輪記錄。**

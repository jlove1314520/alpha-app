...
**馬拉松全局輪次計數器（2026-08-23 新增，使用者要求）：目前累積 565 輪（含補記的第405輪，見下方缺口說明）。最新一輪：第 565 輪 · 2026-09-19T17:03+08:00 · TW（零股失衡度.連續曝險版重測：檢定力前置關卡STATISTICAL_GATE_FAIL不准開跑，未登記試驗；詳見REPORT.md第565輪）

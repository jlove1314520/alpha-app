...
- [ ] **修.四** [債務] daily_price日期欄位修正(核准)——parsers.py的
...
- [ ] **結.一** [研究] 考.一結案確認——#398 f52w、#399 dividend依事前
...
- [ ] **新.一** [研究] BLOCKED於結.一後——新候選事前登記：
  ...
  改用其他比例。③登記為新試驗計入N。
- [ ] **H.一** [研究] BLOCKED於新.一後——holdout單次解鎖(總司令已核准，
...
- [ ] **維運查核.排程0446停擺** [維運] 只查證、不修改——①Get-WinEvent查

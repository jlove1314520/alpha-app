...
- [ ] **regime.候選5** [研究] [自走補入]（來源：`research/
...
- [ ] **regime.候選1** [研究] [自走補入]（來源：同上第10節）——市場廣度
  ...
  記錄FAIL，不用勉強做完整協定。
- [ ] **regime.候選4** [研究] [自走補入]（來源：同上第10節）——融資
...
- [ ] **regime.FUT提案** [研究] [自走補入]（來源：`research/

...
A軌（本session正在做）→ B/C/D依序接續，E（稽核.四剩項）已在更早的
稽核.四.1修正版/四.4/四.5輪次做完，本輪視為已達成。二(a)(b)(c)(d)
牛熊制度規則將在A軌power_budget.py完成後、C軌SPEC動筆前補上（C軌的
SPEC本來就需要引用這個窗口清單）。三（TradingView定位）待寫進
CLAUDE.md。四（IDEA_INTAKE.md骨架）待建立。
